...
CREATE  TABLE IF NOT EXISTS `OpenVet13`.`Race` (
  ...
  `idEspeces` INT NOT NULL ,
  `Actif` TINYINT(1) NULL ,
  INDEX `fk_Races_Especes1_idx` (`idEspeces` ASC) ,
  PRIMARY KEY (`idRace`) ,
  CONSTRAINT `fk_Races_Especes1`
    FOREIGN KEY (`idEspeces` )
...
-- -----------------------------------------------------
-- Table `OpenVet13`.`Parametres`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OpenVet13`.`Parametres` ;

CREATE  TABLE IF NOT EXISTS `OpenVet13`.`Parametres` (
...
CREATE  TABLE IF NOT EXISTS `OpenVet13`.`ResultatAnalyse` (
  ...
  CONSTRAINT `fk_ResultatLiquide_Parametres`
    ...
    REFERENCES `OpenVet13`.`Parametres` (`idParametres` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Placeholder table for view `OpenVet13`.`viewAnimal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OpenVet13`.`viewAnimal` (`idAnimal` INT, `Animal_idPere` INT, `Animal_idMere` INT, `Nom` INT, `Especes_idEspeces` INT, `Race_idRace` INT, `Race2_idRace` INT, `Robe` INT, `Sexe` INT, `Naissance` INT, `Sterilise` INT, `DesactiverRelances` INT, `Identification` INT, `Commentaires` INT, `Actif` INT, `idEspeces` INT, `Espece` INT, `idRace1` INT, `Race1` INT, `idRace2` INT, `Race2` INT);
...
USE `OpenVet13`;
DROP procedure IF EXISTS `OpenVet13`.`GetResultatLiquide`;
...
-- -----------------------------------------------------
-- View `OpenVet13`.`viewAnimal`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `OpenVet13`.`viewAnimal` ;
DROP TABLE IF EXISTS `OpenVet13`.`viewAnimal`;
USE `OpenVet13`;
...
START TRANSACTION;
USE `OpenVet13`;
INSERT INTO `OpenVet13`.`Race` (`idRace`, `Race`, `idEspeces`, `Actif`) VALUES (1, 'Européen', 1, NULL);
INSERT INTO `OpenVet13`.`Race` (`idRace`, `Race`, `idEspeces`, `Actif`) VALUES (2, 'Siamois', 1, NULL);
...
START TRANSACTION;
USE `OpenVet13`;
INSERT INTO `OpenVet13`.`Animal` (`idAnimal`, `Animal_idPere`, `Animal_idMere`, `Nom`, `Especes_idEspeces`, `Race_idRace`, `Race2_idRace`, `Robe`, `Sexe`, `Naissance`, `Sterilise`, `DesactiverRelances`, `Identification`, `Commentaires`, `Actif`) VALUES (1, NULL, NULL, 'Toto', 1, 1, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `OpenVet13`;
INSERT INTO `OpenVet13`.`Analyse` (`idAnalyse`, `Consultation_idConsultation`, `TypeAnalyse_idTypeAnalyse`, `DateHeure`, `DescriptionAnalyse`, `Prelevement`, `SyntheseAnalyse`, `Conclusions`) VALUES (1, 1, 1, NULL, 'Radio Thoracique', NULL, NULL, NULL);
INSERT INTO `OpenVet13`.`Analyse` (`idAnalyse`, `Consultation_idConsultation`, `TypeAnalyse_idTypeAnalyse`, `DateHeure`, `DescriptionAnalyse`, `Prelevement`, `SyntheseAnalyse`, `Conclusions`) VALUES (2, 2, 2, NULL, 'Numération-Formule', NULL, NULL, NULL);
...
-- -----------------------------------------------------
-- Data for table `OpenVet13`.`Parametres`
-- -----------------------------------------------------
START TRANSACTION;
USE `OpenVet13`;
INSERT INTO `OpenVet13`.`Parametres` (`idParametres`, `AnalysesTypes_idAnalysesTypes`, `Especes_idEspeces`, `Parametre`, `IsQuantitatif`, `Unite`, `NormeMin`, `NormeMax`, `Remarque`) VALUES (1, 3, 1, 'Urée', 1, 'g/l', 0.4, 0.7, NULL);
INSERT INTO `OpenVet13`.`Parametres` (`idParametres`, `AnalysesTypes_idAnalysesTypes`, `Especes_idEspeces`, `Parametre`, `IsQuantitatif`, `Unite`, `NormeMin`, `NormeMax`, `Remarque`) VALUES (2, 3, 2, 'Urée', 1, 'g/l', 0.4, 0.8, NULL);
INSERT INTO `OpenVet13`.`Parametres` (`idParametres`, `AnalysesTypes_idAnalysesTypes`, `Especes_idEspeces`, `Parametre`, `IsQuantitatif`, `Unite`, `NormeMin`, `NormeMax`, `Remarque`) VALUES (3, 3, 1, 'Créatinine', 1, 'mg/l', 10, 20, NULL);
INSERT INTO `OpenVet13`.`Parametres` (`idParametres`, `AnalysesTypes_idAnalysesTypes`, `Especes_idEspeces`, `Parametre`, `IsQuantitatif`, `Unite`, `NormeMin`, `NormeMax`, `Remarque`) VALUES (4, 3, 1, 'FIV', 0, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `OpenVet13`;
INSERT INTO `OpenVet13`.`ResultatAnalyse` (`idResultatAnalyse`, `Analyse_idAnalyse`, `Parametres_idParametres`, `Valeur`, `Image`, `TitreImage`, `Description`, `FichierExterne`, `Remarque`) VALUES (1, 1, 1, 1.2, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `OpenVet13`.`ResultatAnalyse` (`idResultatAnalyse`, `Analyse_idAnalyse`, `Parametres_idParametres`, `Valeur`, `Image`, `TitreImage`, `Description`, `FichierExterne`, `Remarque`) VALUES (2, 1, 3, 44, NULL, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `OpenVet13`;
INSERT INTO `OpenVet13`.`PathologieRef` (`idPathologieRef`, `Consultation_idConsultation`, `Pathologie_idPathologie`) VALUES (1, 1, 1);
INSERT INTO `OpenVet13`.`PathologieRef` (`idPathologieRef`, `Consultation_idConsultation`, `Pathologie_idPathologie`) VALUES (2, 2, 2);
INSERT INTO `OpenVet13`.`PathologieRef` (`idPathologieRef`, `Consultation_idConsultation`, `Pathologie_idPathologie`) VALUES (3, 1, 3);
...
START TRANSACTION;
USE `OpenVet13`;
INSERT INTO `OpenVet13`.`CritereSeuil` (`idCritereSeuil`, `Critere_idCritere`, `LimiteInf`, `LimiteSup`, `Grade`, `Score`) VALUES (1, 1, NULL, 6, '0', NULL);
INSERT INTO `OpenVet13`.`CritereSeuil` (`idCritereSeuil`, `Critere_idCritere`, `LimiteInf`, `LimiteSup`, `Grade`, `Score`) VALUES (2, 1, 6, 7.5, '1', NULL);
INSERT INTO `OpenVet13`.`CritereSeuil` (`idCritereSeuil`, `Critere_idCritere`, `LimiteInf`, `LimiteSup`, `Grade`, `Score`) VALUES (5, 4, 0.9, 1.2, '0', NULL);
INSERT INTO `OpenVet13`.`CritereSeuil` (`idCritereSeuil`, `Critere_idCritere`, `LimiteInf`, `LimiteSup`, `Grade`, `Score`) VALUES (3, 1, 7.5, 9, '2', NULL);
INSERT INTO `OpenVet13`.`CritereSeuil` (`idCritereSeuil`, `Critere_idCritere`, `LimiteInf`, `LimiteSup`, `Grade`, `Score`) VALUES (4, 1, 9, NULL, '3', NULL);
