...
class DataBase:
    ...
    def Connection(self):
        ...
        try :
            ...
            conn.Connect('localhost',self.user,self.pwd,self.nomDB)  
        except :
...
class Champ:
    ...
    def ConvertirEnDateTime(self, valeur) :
        try :
            ...
            err='Erreur table.py Champ:ConvertirEnDateTime  date='+str(valeur)
        return (err, valeur)
...
#        self.ListeTableEnfant=None
    ...
    def ListeChampModifiable(self):   #autorise modification de tous les champs SAUF clef primaire ET unqi
        ...
        try :
            ...
            msg= 'Erreur /except Table.py ('+self.NomTable+') ListeChampModifiable() '
            if AFFICHE_CONSOLE :
                print msg
    ...
    def LectureId(self, id ) : #lit la ligne  no id 
        try :
            ...
            msg="Erreur /except Table.py    Table.lectureId id:"+str(id)+" introuvable??? "+listeerreurs
...
#        unetable=Table(self.nomDB,self.NomTable, self.NomTableBase, True, USER, PWD, dataBase=self.DataBase)
    ...
    def RequeteSet(self):
        ...
        try :
            ...
            msg =  'erreur Table.py RequeteSet() :'+sql+'champ:'+champ.Nom()
            slq=msg
            if AFFICHE_CONSOLE :    print msg
        ...
        if self.clefprimaire.Value() >0 :
            ...
            try :
                ...
                if type(NbLignesModifiees)==type('string') : 
                    ...
                    return 'Erreur Table.py EnregistreTable() creation nouvelle ligne'+NbLignesModifiees
                elif NbLignesModifiees == 0 :
                    err='Warning : aucune ligne modifiée= '                
            except :
                self.clefprimaire.SetDirect(-1)
                return 'Erreur except Table.py EnregistreTable() retrouve no clefprimaire'
            return err
