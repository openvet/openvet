...
BEGIN
SELECT idCritere,Examen_idExamen,Critere,Unite,IF(NbGrades IS NULL,0,NbGrades) AS NbGrades,
...
BEGIN
SELECT idCritere,Examen,IF(CHAR_LENGTH(Remarque)>100 OR Remarque iS NULL, Critere,CONCAT(Critere," (",Remarque,")")) AS Critere,Unite,
(SELECT CONCAT(IF(LimiteInf IS NULL,"...",CAST(LimiteInf AS CHAR(10)))," - ",IF(LimiteSup IS NULL,"...",CAST(LimiteSup AS CHAR(10)))) FROM CritereSeuil WHERE Critere_idCritere=idCritere AND Grade=0) AS Norme,
...
START TRANSACTION;
USE `OpenVet12`;
INSERT INTO `OpenVet12`.`Consultation` (`idConsultation`, `Animal_idAnimal`, `DateConsultation`, `TypeConsultation_idTypeConsultation`, `Personne_idConsultant`, `Personne_idReferant`, `Examen`, `Traitement`, `Actif`, `Commentaires`) VALUES (1, 1, '2012-02-25', 5, 1, 2, 'Galop Cardiaque. Tension augmentée', 'Hypercard', TRUE, 'Quelque chose sans signification.');
INSERT INTO `OpenVet12`.`Consultation` (`idConsultation`, `Animal_idAnimal`, `DateConsultation`, `TypeConsultation_idTypeConsultation`, `Personne_idConsultant`, `Personne_idReferant`, `Examen`, `Traitement`, `Actif`, `Commentaires`) VALUES (2, 1, '2013-03-08', 2, 2, NULL, 'Vomissements,Amaigrissement. Palaption masse abdominale.', 'inj Dexafort.', TRUE, NULL);
