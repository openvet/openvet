...
class FormAnimal(FormulaireBase):
    def __init__(self, parent=None, animal=None):
        ...
        self.TypeChamp={'Naissance':'date','Sexe':'comboBox', 'Sterilise':'checkBox', 'Commentaires':'textEdit','Especes_idEspeces':'myComboEspece', 'Race_idRace':'myComboRace', 'Race2_idRace':'myComboRace','DesactiverRelances':'checkBox'}
