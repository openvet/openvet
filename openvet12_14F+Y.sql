...
-- -----------------------------------------------------
-- Table `OpenVet12`.`Unite`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OpenVet12`.`Unite` ;

CREATE  TABLE IF NOT EXISTS `OpenVet12`.`Unite` (
...
CREATE  TABLE IF NOT EXISTS `OpenVet12`.`Critere` (
  ...
  CONSTRAINT `fk_Critere_Unite`
    ...
    REFERENCES `OpenVet12`.`Unite` (`idUnite` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `OpenVet12`.`Parametre`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OpenVet12`.`Parametre` ;

CREATE  TABLE IF NOT EXISTS `OpenVet12`.`Parametre` (
...
CREATE  TABLE IF NOT EXISTS `OpenVet12`.`ResultatAnalyse` (
  ...
  CONSTRAINT `fk_ResultatLiquide_Parametres`
    ...
    REFERENCES `OpenVet12`.`Parametre` (`idParametre` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `OpenVet12`.`ConsultationCritere` (
  ...
  CONSTRAINT `fk_ConsultationCritere_PathologieRef`
    ...
    REFERENCES `OpenVet12`.`PathologieRef` (`idPathologieRef` )
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- View `OpenVet12`.`viewConsultation`
-- -----------------------------------------------------
DROP VIEW IF EXISTS `OpenVet12`.`viewConsultation` ;
DROP TABLE IF EXISTS `OpenVet12`.`viewConsultation`;
USE `OpenVet12`;
CREATE  OR REPLACE VIEW `OpenVet12`.`viewConsultation` AS SELECT idConsultation,Animal_idAnimal,DateConsultation,TypeConsultation_idTypeConsultation,TypeConsultation,
...
-- -----------------------------------------------------
-- Table `OpenVet12`.`CritereRef`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OpenVet12`.`CritereRef` ;

CREATE  TABLE IF NOT EXISTS `OpenVet12`.`CritereRef` (
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`GetCritereEdit`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`GetNewConsultationCritere`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`GetSeuil`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`GetPathologieRef`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`GetCritereGrades`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`GetDomaine_id`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`CheckDoublonPathologie`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`CheckUsedPathologie`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`GetPathologieDomaine`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`CheckDoublonCritere`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`GetAnalysesAnimal`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`IsAnalyseImage`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`GetParametres`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`GetResultatParametres`;
...
USE `OpenVet12`;
DROP procedure IF EXISTS `OpenVet12`.`IsAnalyseParam`;
...
USE `OpenVet12`$$
DROP TRIGGER IF EXISTS `OpenVet12`.`IsAnalyseUnique` $$
USE `OpenVet12`$$
...
USE `OpenVet12`$$
DROP TRIGGER IF EXISTS `OpenVet12`.`IsPathologieRefUnique` $$
USE `OpenVet12`$$
...
START TRANSACTION;
USE `OpenVet12`;
INSERT INTO `OpenVet12`.`Analyse` (`idAnalyse`, `Consultation_idConsultation`, `TypeAnalyse_idTypeAnalyse`, `DateHeure`, `DescriptionAnalyse`, `Prelevement`, `SyntheseAnalyse`, `Conclusions`, `Identifiant`) VALUES (1, 1, 1, '2012-02-25:14:10:00', 'Radio Thoracique', NULL, NULL, 'Epanchement', NULL);
INSERT INTO `OpenVet12`.`Analyse` (`idAnalyse`, `Consultation_idConsultation`, `TypeAnalyse_idTypeAnalyse`, `DateHeure`, `DescriptionAnalyse`, `Prelevement`, `SyntheseAnalyse`, `Conclusions`, `Identifiant`) VALUES (2, 2, 3, '2013-03-08:00:00:00', 'IR', 'sang héparine', 'blabla', 'Anémie non régénérative avec microglobilie et corps de heinz et blalaaakj sdfsdfsqdf  fsqdfqsfqsfsqf   sdfqsfsfsf', NULL);
...
-- -----------------------------------------------------
-- Data for table `OpenVet12`.`Unite`
-- -----------------------------------------------------
START TRANSACTION;
USE `OpenVet12`;
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (1, 'mm');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (2, 'cm');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (3, 'm/s');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (4, 'g');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (5, 'mg');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (6, 'g/l');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (7, 'mg/l');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (8, 'mg/dl');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (9, 'mmol/l');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (10, 'UI');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (11, 'pg/l');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (12, 'µg/l');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (13, 'ms');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (14, 'cm/s');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (15, 'aucune');
INSERT INTO `OpenVet12`.`Unite` (`idUnite`, `Unite`) VALUES (16, 'UI/ml');
...
START TRANSACTION;
USE `OpenVet12`;
INSERT INTO `OpenVet12`.`Critere` (`idCritere`, `Examen_idExamen`, `Critere`, `Unite_idUnite`, `NbGrades`, `Remarque`) VALUES (1, 1, 'Epaisseur SIVd', 1, 3, 'en diastole');
INSERT INTO `OpenVet12`.`Critere` (`idCritere`, `Examen_idExamen`, `Critere`, `Unite_idUnite`, `NbGrades`, `Remarque`) VALUES (2, 1, 'Epaisseur PPG', 1, NULL, NULL);
INSERT INTO `OpenVet12`.`Critere` (`idCritere`, `Examen_idExamen`, `Critere`, `Unite_idUnite`, `NbGrades`, `Remarque`) VALUES (3, 1, 'Sténose sous Aortique', NULL, NULL, NULL);
INSERT INTO `OpenVet12`.`Critere` (`idCritere`, `Examen_idExamen`, `Critere`, `Unite_idUnite`, `NbGrades`, `Remarque`) VALUES (4, 2, 'Rapport E/A', NULL, NULL, NULL);
INSERT INTO `OpenVet12`.`Critere` (`idCritere`, `Examen_idExamen`, `Critere`, `Unite_idUnite`, `NbGrades`, `Remarque`) VALUES (5, 2, 'Durée Ar Veine Pulmonaire', 13, NULL, NULL);
INSERT INTO `OpenVet12`.`Critere` (`idCritere`, `Examen_idExamen`, `Critere`, `Unite_idUnite`, `NbGrades`, `Remarque`) VALUES (6, 2, 'Onde S/D Veine Pulmonaire', NULL, NULL, 'Non validé');
...
-- -----------------------------------------------------
-- Data for table `OpenVet12`.`Parametre`
-- -----------------------------------------------------
START TRANSACTION;
USE `OpenVet12`;
INSERT INTO `OpenVet12`.`Parametre` (`idParametre`, `TypeAnalyse_idTypeAnalyse`, `Especes_idEspeces`, `Parametre`, `IsQuantitatif`, `Unite_idUnite`, `NormeMin`, `NormeMax`, `Remarque`, `IsActif`) VALUES (1, 3, 1, 'Urée', 1, 6, 0.4, 0.7, NULL, 1);
INSERT INTO `OpenVet12`.`Parametre` (`idParametre`, `TypeAnalyse_idTypeAnalyse`, `Especes_idEspeces`, `Parametre`, `IsQuantitatif`, `Unite_idUnite`, `NormeMin`, `NormeMax`, `Remarque`, `IsActif`) VALUES (2, 3, 2, 'Urée', 1, 6, 0.4, 0.8, NULL, 1);
INSERT INTO `OpenVet12`.`Parametre` (`idParametre`, `TypeAnalyse_idTypeAnalyse`, `Especes_idEspeces`, `Parametre`, `IsQuantitatif`, `Unite_idUnite`, `NormeMin`, `NormeMax`, `Remarque`, `IsActif`) VALUES (3, 3, 1, 'Créatinine', 1, 7, 10, 20, NULL, 1);
INSERT INTO `OpenVet12`.`Parametre` (`idParametre`, `TypeAnalyse_idTypeAnalyse`, `Especes_idEspeces`, `Parametre`, `IsQuantitatif`, `Unite_idUnite`, `NormeMin`, `NormeMax`, `Remarque`, `IsActif`) VALUES (4, 5, 1, 'FIV', 0, NULL, NULL, NULL, NULL, 1);
INSERT INTO `OpenVet12`.`Parametre` (`idParametre`, `TypeAnalyse_idTypeAnalyse`, `Especes_idEspeces`, `Parametre`, `IsQuantitatif`, `Unite_idUnite`, `NormeMin`, `NormeMax`, `Remarque`, `IsActif`) VALUES (NULL, 3, 1, 'ALAT', 1, 16, 20, 60, NULL, 1);
INSERT INTO `OpenVet12`.`Parametre` (`idParametre`, `TypeAnalyse_idTypeAnalyse`, `Especes_idEspeces`, `Parametre`, `IsQuantitatif`, `Unite_idUnite`, `NormeMin`, `NormeMax`, `Remarque`, `IsActif`) VALUES (NULL, 3, 1, 'PAL', 1, 16, 30, 120, NULL, 1);
...
START TRANSACTION;
USE `OpenVet12`;
INSERT INTO `OpenVet12`.`ResultatAnalyse` (`idResultatAnalyse`, `Analyse_idAnalyse`, `Parametre_idParametre`, `ValeurQuant`, `ValeurQual`, `Image`, `TitreImage`, `Description`, `FichierExterne`, `Remarque`) VALUES (1, 2, 1, 1.2, NULL, NULL, NULL, NULL, NULL, 'just fo fun');
INSERT INTO `OpenVet12`.`ResultatAnalyse` (`idResultatAnalyse`, `Analyse_idAnalyse`, `Parametre_idParametre`, `ValeurQuant`, `ValeurQual`, `Image`, `TitreImage`, `Description`, `FichierExterne`, `Remarque`) VALUES (2, 2, 3, 14, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `OpenVet12`.`ResultatAnalyse` (`idResultatAnalyse`, `Analyse_idAnalyse`, `Parametre_idParametre`, `ValeurQuant`, `ValeurQual`, `Image`, `TitreImage`, `Description`, `FichierExterne`, `Remarque`) VALUES (3, 1, NULL, NULL, NULL, 'fichier1', 'Radio blabla', 'on voit des trucs', NULL, NULL);
INSERT INTO `OpenVet12`.`ResultatAnalyse` (`idResultatAnalyse`, `Analyse_idAnalyse`, `Parametre_idParametre`, `ValeurQuant`, `ValeurQual`, `Image`, `TitreImage`, `Description`, `FichierExterne`, `Remarque`) VALUES (4, 2, NULL, NULL, NULL, NULL, NULL, NULL, 'cal.pdf', NULL);
...
START TRANSACTION;
USE `OpenVet12`;
INSERT INTO `OpenVet12`.`PathologieRef` (`idPathologieRef`, `Consultation_idConsultation`, `Pathologie_idPathologie`, `Identifiant`) VALUES (1, 1, 1, NULL);
INSERT INTO `OpenVet12`.`PathologieRef` (`idPathologieRef`, `Consultation_idConsultation`, `Pathologie_idPathologie`, `Identifiant`) VALUES (2, 2, 2, NULL);
INSERT INTO `OpenVet12`.`PathologieRef` (`idPathologieRef`, `Consultation_idConsultation`, `Pathologie_idPathologie`, `Identifiant`) VALUES (3, 1, 3, NULL);
...
START TRANSACTION;
USE `OpenVet12`;
INSERT INTO `OpenVet12`.`ConsultationCritere` (`idConsultationCritere`, `Critere_idCritere`, `PathologieRef_idPathologieRef`, `CritereQuantitatif`, `CritereQualitatif`, `Grade`) VALUES (1, 1, 1, 8, NULL, '2/3');
INSERT INTO `OpenVet12`.`ConsultationCritere` (`idConsultationCritere`, `Critere_idCritere`, `PathologieRef_idPathologieRef`, `CritereQuantitatif`, `CritereQualitatif`, `Grade`) VALUES (2, 2, 1, 6.5, NULL, '1/3');
INSERT INTO `OpenVet12`.`ConsultationCritere` (`idConsultationCritere`, `Critere_idCritere`, `PathologieRef_idPathologieRef`, `CritereQuantitatif`, `CritereQualitatif`, `Grade`) VALUES (3, 3, 1, NULL, 'absence', '0');
INSERT INTO `OpenVet12`.`ConsultationCritere` (`idConsultationCritere`, `Critere_idCritere`, `PathologieRef_idPathologieRef`, `CritereQuantitatif`, `CritereQualitatif`, `Grade`) VALUES (4, 4, 1, 0.8, NULL, '1/3');
...
START TRANSACTION;
USE `OpenVet12`;
INSERT INTO `OpenVet12`.`CritereSeuil` (`idCritereSeuil`, `Critere_idCritere`, `LimiteInf`, `LimiteSup`, `Grade`, `Score`, `Remarque`) VALUES (1, 1, NULL, 6, 0, NULL, NULL);
INSERT INTO `OpenVet12`.`CritereSeuil` (`idCritereSeuil`, `Critere_idCritere`, `LimiteInf`, `LimiteSup`, `Grade`, `Score`, `Remarque`) VALUES (2, 1, 6, 7.5, 1, NULL, NULL);
INSERT INTO `OpenVet12`.`CritereSeuil` (`idCritereSeuil`, `Critere_idCritere`, `LimiteInf`, `LimiteSup`, `Grade`, `Score`, `Remarque`) VALUES (5, 4, 0.9, 1.2, 0, NULL, NULL);
INSERT INTO `OpenVet12`.`CritereSeuil` (`idCritereSeuil`, `Critere_idCritere`, `LimiteInf`, `LimiteSup`, `Grade`, `Score`, `Remarque`) VALUES (3, 1, 7.5, 9, 2, NULL, NULL);
INSERT INTO `OpenVet12`.`CritereSeuil` (`idCritereSeuil`, `Critere_idCritere`, `LimiteInf`, `LimiteSup`, `Grade`, `Score`, `Remarque`) VALUES (4, 1, 9, NULL, 3, NULL, NULL);

COMMIT;

-- -----------------------------------------------------
-- Data for table `OpenVet12`.`CritereRef`
-- -----------------------------------------------------
START TRANSACTION;
USE `OpenVet12`;
INSERT INTO `OpenVet12`.`CritereRef` (`idCritereRef`, `Pathologie_idPathologie`, `Critere_idCritere`) VALUES (1, 1, 1);
INSERT INTO `OpenVet12`.`CritereRef` (`idCritereRef`, `Pathologie_idPathologie`, `Critere_idCritere`) VALUES (2, 1, 2);
INSERT INTO `OpenVet12`.`CritereRef` (`idCritereRef`, `Pathologie_idPathologie`, `Critere_idCritere`) VALUES (3, 1, 3);
INSERT INTO `OpenVet12`.`CritereRef` (`idCritereRef`, `Pathologie_idPathologie`, `Critere_idCritere`) VALUES (4, 1, 4);
INSERT INTO `OpenVet12`.`CritereRef` (`idCritereRef`, `Pathologie_idPathologie`, `Critere_idCritere`) VALUES (5, 1, 5);
INSERT INTO `OpenVet12`.`CritereRef` (`idCritereRef`, `Pathologie_idPathologie`, `Critere_idCritere`) VALUES (6, 1, 6);
